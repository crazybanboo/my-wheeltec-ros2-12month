...
void SlamGmapping::init() {
    ...
    this->declare_parameter("odom_frame", "odom_combined");
    this->declare_parameter("transform_publish_period", 0.05);
    this->declare_parameter("map_update_interval", 1.0);
    this->declare_parameter("maxUrange", 80.0);
    this->declare_parameter("maxRange", 0.0);
    ...
    this->declare_parameter("particles", 20); // Reduced from 30
    this->declare_parameter("xmin", -10.0);
    this->declare_parameter("ymin", -10.0);
    this->declare_parameter("xmax", 10.0);
    this->declare_parameter("ymax", 10.0);
    ...
    double map_update_interval_double;
    this->get_parameter("map_update_interval", map_update_interval_double);
    map_update_interval_ = tf2::durationFromSec(map_update_interval_double);
